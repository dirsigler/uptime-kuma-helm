...
![Version: 4.2.0](https://img.shields.io/badge/Version-4.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.3.0](https://img.shields.io/badge/AppVersion-2.3.0-informational?style=flat-square)
...
| ingress.tls | list | `[]` |  |
| initContainers | list | `[]` | List of initialization or sidecar containers to be added to the deployment ref: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/ ref: https://kubernetes.io/docs/concepts/workloads/pods/sidecar-containers/ |
